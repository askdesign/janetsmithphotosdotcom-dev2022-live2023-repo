		...
		<footer class="entry-utility<?php echo weaverx_text_class( 'post_info_bottom' ); ?>">
			...
			if ( $categories_list ):
				...
				<span class="cat-links">
					<?php printf( wp_kses( __( '<span class="%1$s">Posted in</span> %2$s', 'weaver-xtreme' ) ), 'entry-utility-prep entry-utility-prep-cat-links', $categories_list ); ?>
				</span>
			...
			if ( $tags_list ): ?>
				<span class="tag-links">
					<?php printf( wp_kses( __( '<span class="%1$s">Tagged</span> %2$s', 'weaver-xtreme' ) ), 'entry-utility-prep entry-utility-prep-tag-links', $tags_list ); ?>
				</span>
